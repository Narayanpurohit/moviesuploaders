    ...
    if update.from_user.id in (Config.AUTH_USERS & Config.LAZY_DEVELOPER):
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("⚡️𝔖𝔲𝔭𝔭𝔬𝔯𝔱", url="https://t.me/beautyofthemoviesdiscussion"),
                        InlineKeyboardButton("✪ ＹＴ ✪", url="https://www.youtube.com/@Lyrics_of_kstatus"),
                        InlineKeyboardButton("⚡️ U𝖕𝖉𝖆𝖙e", url="https://t.me/+6CoF0hnHLnI5ZjRl"),
                    ],
